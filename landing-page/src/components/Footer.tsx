      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Lexicode.ai</span>
            </div>
            <p className="text-gray-400 text-sm max-w-xs">
              Automatic code documentation that stays up to date. Never worry about outdated docs again.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#docs" className="text-gray-400 hover:text-white text-sm transition-colors">Documentation</a></li>
              <li><a href="#api" className="text-gray-400 hover:text-white text-sm transition-colors">API</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Lexicode.ai. All rights reserved.
          </p>
