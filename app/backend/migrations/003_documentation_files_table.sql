...
-- Add updated_at trigger for summaries
CREATE TRIGGER update_documentation_summaries_updated_at 
    BEFORE UPDATE ON documentation_summaries
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

-- Add comments for summaries
